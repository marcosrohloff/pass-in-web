          ...
          <tbody>
            {Array.from({length: 8}).map((_, i) => {
              return (
                ...
                <td className='py-3 px-4 text-sm text-zinc-300'>123324</td>
                <td className='py-3 px-4 text-sm text-zinc-300'>
                  <div className='flex flex-col gap-1'>
                    <span className='font-semibold text-white'>Marcos Fernando</span>
                    <span>teste@dsda.com</span>
                  </div>
                </td>
